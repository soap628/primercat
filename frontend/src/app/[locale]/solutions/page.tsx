...
const COPY = {
  zh: {
    kicker: "实验室计算与配方",
    title: "实验室溶液配制",
    intro: "提供摩尔浓度、稀释与百分浓度计算，以及可按终体积缩放的参考配方。每项配方标注组分、步骤、安全提示与来源。",
    heroMetric: "资料范围",
    heroValue: "3 类计算 · 29 个配方",
    heroBody: "配方原料关联试剂安全资料，并标注加料顺序、不相容性和废液处理边界。",
    calculator: "通用计算器",
  ...
  en: {
    kicker: "Laboratory calculations & formulations",
    title: "Laboratory solution preparation",
    intro: "Calculate molarity, dilution, and percentage solutions, then use reference formulations that scale by final volume. Each recipe identifies ingredients, steps, safety notes, and sources.",
    heroMetric: "Reference scope",
    heroValue: "3 calculators · 29 recipes",
    heroBody: "Recipe ingredients link to reagent-safety records, with addition order, incompatibilities, and waste-handling boundaries shown on each card.",
